...
const setConceptIdSubstance = (conceptId: string) => {
        ...
        <div className="col-9 col-md-10">
          ...
          {!branchRequest.loading && !branchRequest.error && (
            <form onSubmit={handleFormSubmit}>
                ...
                <div className="row">
                  <div className="col-md-8">
                    <div className="form-group">
                      ...
                      <DrugAutoSuggest host={host} branch={branch} suggestCallback={setConceptIdSubstance}/>
                      {/*<input
                        id="query"
                        className="form-control"
                        type="text"
              ...
              <DrugListComponent genericUrl={fetchGenericUrl} commercialUrl={fetchCommercial}/>
            </form>
          )}
        </div>
